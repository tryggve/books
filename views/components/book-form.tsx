...
const input = css`padding: 10px 5px; width: 100%; border: 1px solid var(--color-border-secondary); border-radius: 8px;`
const select = css`border: 1px solid var(--color-border-secondary); border-radius: 8px;`
        ...
        <div class={container}>
            ...
            <form id="book-form" method="post" action="/books" class={bookForm}>
                ...
                <div>
                    ...
                    <select name="author" id="book-author" class={input} required>
                ...
                <div class={seriesWrapper}>
                    <div>
                        ...
                        <select name="series" id="book-series" class={input}>
                ...
                <div class={checkboxWrapper}>
                    <label class={checkboxLabel}>
                        <input type="checkbox" name="read" id="read-check" class={select} value="true" /> Läst
                    </label>
                    <label class={checkboxLabel}>
                        <input type="checkbox" name="owned" id="owned-check" class={select} value="true" /> Äger
                    </label>
                </div>
